      ...
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/2">
            ...
            {/* Social Media Links */}
            <div className="flex space-x-4 mt-4 lg:mt-0 lg:ml-6">
              <a href="https://github.com/HorizonHash" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white transition-colors" title="GitHub">
              ...
              <a href="https://twitter.com/HorizonHash" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white transition-colors" title="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
